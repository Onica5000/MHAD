...
This tool only pre-fills a Mental Health Advance Directive, so the upload must be about the person's HEALTH, CARE, or an advance directive. Relevant examples: a medical record, discharge/visit summary, treatment or care plan, medication or allergy list, psychiatric evaluation, hospital paperwork, an existing advance directive / living will / mental-health power of attorney, or a health intake questionnaire (including spoken wishes).
If the document is clearly NOT about the person's health, care, treatment, or an advance directive — for example a lease or rental agreement, mortgage/loan/financial/insurance contract, invoice or receipt, utility bill, tax form, pay stub, résumé, or other unrelated paperwork — then you MUST:
