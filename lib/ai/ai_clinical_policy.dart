...
/// (`gemini_api_assistant.dart` rules 11–20) carries an expanded, numbered
/// version of the same policy — the MAY / DUTY / NEVER clauses (especially
/// every verb in the NEVER list) must stay semantically identical in both;
/// change them together (verified in the 2026-07-08 AI audit).
///
